/***************************************************************************
    qgssimplefeaturegeometryengine.h
    ---------------------
    begin                : 03.03.2016
...
#ifndef QGSSIMPLEFEATUREGEOMETRYENGINE_H
#define QGSSIMPLEFEATUREGEOMETRYENGINE_H

#include "qgsgeometry.h"

/**
 * This class defines geometry processing methods according to the 
 * Open GIS Simple Feature Specification.
 * See:
 * http://www.opengeospatial.org/standards/sfa
 */
class CORE_EXPORT QgsSimpleFeatureGeometryEngine
{
  protected:
    /**
     ...
     * @param geometry
     */
    QgsSimpleFeatureGeometryEngine( const QgsGeometry& geometry, double precision = 0 );
  ...
  public:
     ...
     */
    virtual QgsGeometry intersection( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual QgsGeometry difference( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual QgsGeometry combine( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual QgsGeometry combine( const QList<QgsGeometry*>& geometryList, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual QgsGeometry symDifference( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual QgsGeometry buffer( double distance, int segments, QString* errorMsg = nullptr ) const = 0;
     ...
     * @returns a polygonal geometry representing the buffer region (which may be empty)
     */
    virtual QgsGeometry buffer( double distance, int segments, int endCapStyle, int joinStyle, double mitreLimit, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual QgsGeometry simplify( double tolerance, bool preservingTopology = true, QString* errorMsg = nullptr ) const = 0;
     ...
     * @returns the point
     */
    virtual QgsGeometry interpolate( double distance, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual QgsGeometry envelope( QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual bool centroid( QgsPointV2& point, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual bool pointOnSurface( QgsPointV2& point, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual QgsGeometry convexHull( QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual double distance( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual QgsGeometry offsetCurve( double distance, int segments, int joinStyle, double mitreLimit, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual bool intersects( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual bool touches( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual bool crosses( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual bool within( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual bool overlaps( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual bool contains( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual bool disjoint( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual QString relate( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual bool relatePattern( const QgsGeometry& other, const QString& pattern, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual bool isEqual( const QgsGeometry& other, QString* errorMsg = nullptr ) const = 0;
     ...
     */
    virtual bool isEmpty( QString* errorMsg = nullptr ) const = 0;

  protected:
    /** The geometry to manage */
    const QgsGeometry& mGeometry;

    /** Coordinate precision of the geometry */
    double mPrecision;
};

#endif // QGSSIMPLEFEATUREGEOMETRYENGINE_H
